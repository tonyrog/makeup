...
%%% Description : UTF-16 (Little endian) processing
%%% Created : 27 Feb 2006 by Tony Rogvall <tony@iMac.local>

-module(makeup_utf16_le).

-rcsid("$Id: makeup_utf16_le.erl,v 1.2 2006/03/06 19:47:32 tony Exp $\n").

-vsn("$Revision: 1.2 $ ").

-export([input/1, input/4]).
-compile(export_all).

-include("makeup_utf.hrl").

-define(U16(X), (X):16/unsigned-little-integer).
